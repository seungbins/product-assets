...
CNKI·만방데이터·웨이푸·바이두쉐수 등에서 약 48개 검색어로 조사(직접 접근은 다수 403/503으로 차단되어 학술지 공식 홈페이지 목차·DOI·복수 독립 출처 교차검증으로 실존 확인). **결과가 주제별로 극단적으로 불균형합니다** — 정책·법률 연구는 풍부하지만, 우윤(乌云网) 등 **중국 플랫폼 자체를 다룬 학술 사례연구**나 **중국 백햇 해커의 동기·행동을 다룬 학술 연구**는 단 한 편도 찾지 못했습니다. 이는 검색 실패가 아니라 흥미로운 발견입니다 — 우윤은 중국 사이버보안 역사의 상징적 플랫폼이지만, 그 데이터를 학술적으로 분석한 논문은 (이 목록의 2장에도 있듯) 대부분 서구 학자(Zhao, Grossklags 등)가 영어로 쓴 것이고, 중국어권 자체 학술연구는 확인되지 않았습니다.

### 网络安全漏洞挖掘的法律规制研究 (네트워크 보안 취약점 발굴의 법적 규제 연구)
**저자:** 자오징우(赵精武) — 베이징항공항천대학 법학원
**게재처:** 暨南学报(哲学社会科学版), 2017년 39권 5호, pp.24-32
**링크:** https://jnxb.jnu.edu.cn/skb/CN/Y2017/V39/I5 (목차) / 전문은 中国法学网(http://iolaw.cssn.cn/fxyjdt/201706/t20170614_4650942.shtml)에서 무료 열람 가능
**핵심 요약:** "위안웨이 사건" 등 실제 판례를 바탕으로 백햇 해커의 취약점 발굴 행위 합법성 논쟁을 다룸. 중국 형법 285조(컴퓨터 정보시스템 불법침입죄)가 선의의 발굴과 악의적 침입을 구분하지 못해 백햇 활동을 부당하게 제약한다고 지적, HackerOne 등 해외 협력 모델을 참고해 취약점 발굴 입법체계 정비·등급별 평가체계·공私 협력 등록제 등을 제안 — 버그바운티 합법화의 법적 경로를 제시.

### 网络安全漏洞披露规则及其体系设计 (네트워크 보안 취약점 공개 규칙 및 체계 설계)
**저자:** 황다오리(黄道丽) — 공안부 제3연구소
**게재처:** 暨南学报(哲学社会科学版), 2018년 40권 1호, pp.94-106
**링크:** 中国法学网/中国社会科学网 전재본으로 열람 가능
**핵심 요약:** 비공개·완전공개·책임있는 공개·조정된 공개(coordinated disclosure) 4가지 유형의 실무적 변천을 정리하고, 미국이 "책임있는 공개"에서 "조정된 공개"로 이동한 경험을 검토. 중국 네트워크안전법 하의 제품/서비스 제공자·제3자 취약점 플랫폼·정부 3자 간 공개 의무 현황을 분석해, 공개 주체·대상·방식·책임면제 4개 축으로 중국형 취약점 공개 규칙 체계를 설계할 것을 제안.

### 中美网络安全漏洞披露与共享政策研究 (중미 네트워크 보안 취약점 공개·공유 정책 연구)
**저자:** 차오완잉(曹婉莹), 차오쉬둥(曹旭栋), 거핑위안(葛平原), 장위칭(张玉清) — 중국과학원대학
**게재처:** 信息安全研究, 2023년 9권 6호, p.602~
**핵심 요약:** 미국 VEP(취약점 형평성 절차)와 중국 CNVD 등 양국의 공공 취약점 데이터베이스·공개·공유 정책을 체계적으로 비교. 중국 정책의 잠재적 문제를 지적하고 미국 경험에 기반한 개선 방향을 제시.

### 关键信息基础设施保护体系建设与漏洞管理标准化研究 (핵심정보기반시설 보호체계 구축 및 취약점 관리 표준화 연구)
**저자:** 양이웨이(杨一未), 손청하오(孙成昊)
**게재처:** 信息安全研究, 2022년 8권 1호, p.62~
**핵심 요약:** 중국 「핵심정보기반시설 안전보호조례」시행을 배경으로, 관련 기관들의 취약점 발견·보고·처리 과정에 통일된 표준과 부처 간 협업체계가 부족한 문제를 분석. 통합 취약점 관리 플랫폼 구축과 책임 분담 명확화를 제안 — 관련 기관의 취약점 신고·포상 메커니즘 도입에 대한 정책적 참고자료.

### 미국 취약점 공개 정책 비교연구 5편 (동일 주제군, 표로 정리)

"미국 경험을 검토해 중국 정책에 시사점을 제시"하는 유사 주제의 논문 5편이 함께 확인되었습니다 — 전부 학술지 공식 홈페이지 또는 DOI + 복수 독립 출처로 실존 검증됐으나, 주제가 서로 매우 유사해 요약 없이 표로만 정리합니다.

| 제목 | 저자 | 게재처 |
|---|---|---|
| 安全漏洞国际披露政策研究 (안보 취약점 국제 공개 정책 연구) | 시이페이 외 (중국과학원대학) | 信息安全研究 2021, 7권 3호, pp.215-224 |
| 国际安全漏洞公平裁决程序对比研究 (국제 취약점 형평성 절차 비교연구, VEP) | 시이페이 외 | 信息安全研究 2021, 7권 6호, pp.496-502 |
| 美国网络安全漏洞运营机制研究及对我国的启示 (미국 취약점 운영기제 연구 및 중국 시사점) | 양제 외 | 保密科学技术 2020년 7호, pp.56-62 |
| 美国网络安全漏洞披露管理情况研究 (미국 취약점 공개 관리 현황 연구) | 리우리핑 외 (중국전자과기그룹 제30연구소) | 信息安全与通信保密 2024년 6호, pp.30-38 |
| 美国漏洞披露工作再研究及对我国漏洞管理工作的启示 (미국 취약점 공개 업무 재연구 및 중국 시사점, CISA KEV 목록 분석) | 장쓰제 외 | 网络安全技术与应用 2025년 11호, pp.134-137 |

### 众包软件测试技术研究进展 (크라우드소스 소프트웨어 테스팅 기술 연구 동향)
**저자:** 장샤오팡(张小芳), 펑양(冯洋), 리우디(刘迪), 천전위(陈振宇), 쉬바오원(徐宝文) — 쑤저우대·난징대
**게재처:** 软件学报(Journal of Software), 2018년 29권 1호, pp.69-88 (DOI 10.13328/j.cnki.jos.005377)
**링크:** https://www.jos.org.cn/jos/article/abstract/5377 (오픈액세스)
**핵심 요약:** ⚠️ **주제 불일치 주의** — 중국어권에서 가장 권위 있는 크라우드소스 SW테스팅 서베이지만, 대상이 기능·사용성·GUI·성능·보안 테스트를 포괄하는 **일반 크라우드소스 테스팅**이며 "보안 크라우드테스트 vs. 전통 침투테스트"를 전문적으로 비교하는 논문이 아닙니다. 관련 검색어를 십여 가지로 시도했지만 그런 전문 비교 논문 자체를 찾지 못했습니다 — 배경 참고용으로만 포함.

---

> **문헌 공백 (정직하게 기록, 흥미로운 발견 포함):** ① **플랫폼 사례연구** — 우윤(乌云网)·부톈(补天)·러우둥허즈(漏洞盒子)·시엔즈서취(先知社区)·CNVD를 대상으로 한 중국어 동료심사 학술논문은 단 한 편도 찾지 못했습니다. ② **백햇 동기·행동 연구** — 중국 백햇 해커 집단의 동기·행동·진로를 다룬 중국어 학술논문도 찾지 못했습니다. 두 영역 모두 산업 백서·기업 조사보고서(치안신·부톈의 백햇 인재 백서, GeekPwn/텐센트/FreeBuf 조사보고서 등)는 있었지만 동료심사 학술논문이 아니라서 제외했습니다. 이번 조사에서 허위/조작 의심 논문 제목은 발견되지 않았습니다 — 확인된 모든 항목이 실재했고, 공백은 검색 실패가 아니라 실제 문헌 공백으로 보입니다.
...
- 5차 라운드: 중국어권 연구 조사 → 10편 추가(총 58편, 정책·법률 9편 + 주제 일부 불일치로 표시한 크라우드테스팅 서베이 1편). 우윤(乌云网) 등 중국 플랫폼 자체나 중국 백햇 해커 동기·행동을 다룬 중국어 학술논문은 존재하지 않는다는 공백도 확인 — 해당 주제의 학술 연구는 서구 학자들이 영어로 수행한 것뿐이었음.
